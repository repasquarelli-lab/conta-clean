...
import { Check, Undo2, SplitSquareHorizontal } from 'lucide-react';
...
export default function BillItem({ entry, label, variant }: BillItemProps) {
  ...
  return (
    <>
        ...
        <div className="flex flex-col gap-1.5 items-end shrink-0">
          ...
          <div className="flex gap-1">
            <button
              ...
              className="badge-warn cursor-pointer text-xs font-bold flex items-center gap-1 active:scale-95 transition-transform"
      ...
      <PartialPaymentDialog entry={entry} open={showPartial} onClose={() => setShowPartial(false)} />
    </>
  );
}
