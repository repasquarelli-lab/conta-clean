...
import { currency, monthMetrics, paidCount, upcomingBills, dueTodayBills, overdueBills, topCategory, getMonthEntries, ensureMonthFixedBills, todayISO } from '@/lib/store';
...
function MonthNavigator({ month, onChange }: { month: string; onChange: (m: string) => void }) {
